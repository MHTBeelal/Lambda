...
Lambda is a **session-based Retrieval-Augmented Generation (RAG) system** that lets you upload study materials (PDFs) and interact with them using natural language.
...
### 2. Upload Documents
Add PDFs or study material to the session. Lambda automatically chunks them for AI to read and understand.
...
## 🌐 Live URL
### https://l-a-m-b-d-a.streamlit.app
